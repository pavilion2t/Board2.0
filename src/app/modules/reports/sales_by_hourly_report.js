export class SalesByHourlyReportController {
	constructor($scope, $rootScope, reportsFactory, columnDefsFactory, uiGridConstants) {
    'ngInject';
    var columnDefs = [
      ...
      {
        field: "sit_in_gross_sales",
        displayName: 'Dine In Gross Sales',
        width: 200,
